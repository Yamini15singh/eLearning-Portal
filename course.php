...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-info" style="background-color: #28a745!important;">
...
<form method="post">
    <div class="container" style="margin-top: 20px; border: 0px solid black; max-width: 700px; border-radius: 10px;padding:20px; align-items: center;">
    <div class="form-group row">
            <label for="courseid" class="col-sm-2 col-form-label"><strong>Admin Id</strong></label>
            <div class="col-sm-10">
              <input type="text" class="form-control" name="adminid" id="adminid" placeholder="Admin ID" required>
            </div>
        </div>    
    <div class="form-group row">
        ...
        <div class="row">
            <div class="col text-center">
              <button type="submit"  style="background-color: #4caf50" class="btn btn-primary" name="submit" id="btn">Submit</button>
            </div>
        </div>
        </form>
    </div>
