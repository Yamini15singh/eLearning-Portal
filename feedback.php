...
<body>
    ...
    <form method="post">
        <div class="container"
            style="margin-top: border: 0px solid black; max-width: 700px; border-radius: 10px; padding:20px; align-items: center;">
            ...
            <div class="row">
                <div class="col text-center">
                    <button class="btn btn-primary" style="background-color: #4caf50" type="submit" name="submit"
