...
<form method="post">
    <div class="container" style="margin-top: 20px; max-width: 700px; border: 0px solid black; border-radius: 5px;padding:50px; align-items: center;">
        ...
        <div class="row">
            <div class="col text-center ">
              <button class="btn btn-primary"  style="background-color: #4caf50" type="submit" name="register" id="btn">Register</button>
            </div>
        </div>
    </div>
    </form>
